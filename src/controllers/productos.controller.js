...
const productoController = {
    /**
     * Obtener todos los productos con filtros, paginación y sus relaciones
     */
    getAllProductos: async (req, res) => {
        try {
            ...
            // Calcular stock total dinámicamente para cada producto
    ...
    /**
     * Crear un nuevo producto usando transacciones
     */
    ...
    /**
     * Activar o desactivar una oferta y calcular el descuento automáticamente
     */
    ...
    /**
     * Eliminar un producto físicamente si no tiene tallas asociadas
     */
    deleteProducto: async (req, res) => {
        ...
        try {
            ...
            // Validación de integridad: no borrar si tiene tallas relacionadas
