...
// Importar rutas (TODAS con ./routes/...)
...
// ⚠️ IMPORTANTE: NO importes db.js aquí
// ❌ NO PONGAS: import { connectDB } from './config/db.js';
// ❌ NO PONGAS: import { connectDB } from './src/config/db.js';
...
app.get('/', (req, res) => {
    ...
    const modulos = [
        'productos', 'categorías', 'proveedores', 'compras',
